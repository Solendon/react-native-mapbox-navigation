...
final class CustomTopBarViewController: ContainerViewController {
  ...
  private func setupConstraints() {
    NSLayoutConstraint.activate([
      // 🔴 Thanh đỏ phía trên
      redTopView.topAnchor.constraint(equalTo: view.topAnchor),
      redTopView.leadingAnchor.constraint(equalTo: view.leadingAnchor),
      redTopView.trailingAnchor.constraint(equalTo: view.trailingAnchor),
      redTopView.bottomAnchor.constraint(equalTo: instructionsBannerView.topAnchor),
      
      // 🧭 Banner phía dưới
      instructionsBannerView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 10),
      instructionsBannerView.leadingAnchor.constraint(equalTo: view.leadingAnchor),
      instructionsBannerView.trailingAnchor.constraint(equalTo: view.trailingAnchor),
      instructionsBannerView.heightAnchor.constraint(equalToConstant: 100)
    ])
  }
